...
IMPLEMENTED, TESTED, and open as PR #20** — see "Component status" and
...
**PR #20** — see `HANDOFF.md` for its exact commit hashes. The
old
...
3.2 (merged) adds the `StorageProvider` abstraction; Slice 3.3 (PR #20,
not yet merged) adds the document upload endpoint itself
...
committed, pushed, and open as PR #20** — see `HANDOFF.md` for exact status. The
next work, in order:

1. Get PR #20 reviewed and merged.
